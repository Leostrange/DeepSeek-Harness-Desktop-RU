...
## Оригинальный проект и вклад RU-версии

Этот репозиторий использует [официальный DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) как основное программное ядро. Сам Harness предоставляет агентную среду, Web UI и plugin-first архитектуру.

**DeepSeek Harness Desktop RU не переписывает оригинальный Harness.** Основной вклад этой версии — Windows-оболочка для запуска, установщик, упаковка desktop-дистрибутива, автоматическая подготовка окружения и русская локализация интерфейса. Если вам нужна оригинальная кодовая база Harness, документация и актуальная разработка, используйте [официальный репозиторий DeepSeek AI](https://github.com/deepseek-ai/deepseek-harness).

В качестве дополнительного ориентира по desktop-интеграции можно посмотреть открытый проект [DSH Desktop](https://github.com/dataelement/dsh-desktop), который также описывает запуск локального Harness в desktop-оболочке.
